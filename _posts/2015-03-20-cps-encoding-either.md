...
The code used in this post can be accessed through the following files:
  ...
  * The implementation of `CPSEither` [here](https://github.com/manojo/functadelic/blob/master/src/main/scala/barbedwire/FoldLeft.scala). There is a vanilla Scala (aka non-LMS) version [here](https://github.com/manojo/functadelic/blob/master/src/main/scala/cpsencodings/EitherCPS.scala).
  * The `partition` function using the CPS encoding [here](https://github.com/manojo/functadelic/blob/master/src/main/scala/lms/util/EitherCPSOps.scala).
